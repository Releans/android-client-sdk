...
import com.releans.platform.testing.HttpCallBackCatcher;
...
public class ControllerTestBase {
    ...
    private static ReleansAPIClient client;
     ...
     * @return
     */
    protected static ReleansAPIClient getClient() {
        if (client == null) {
            synchronized (clientSync) {
                if (client == null) {
                    client = new ReleansAPIClient();
                }
            }
        }
        return client;
